...
class TestMQTTClient(unittest.TestCase):
    ...
    def test_connect_disconnect(self):
        ...
        ttn_client = mqtt(stubs.apptest["wisnodearduino1"],
                          stubs.apptest["ttn-account-v2.QAT09KX6NTZPal64F1iwMQvTB5kHgQj__nP0etRhSek"],
    ...
    def test_uplink(self):
        ...
        ttn_client._MQTTClient__client.publish(
            "{}/devices/guest/up".format(stubs.apptest["wisnodearduino1"]),
